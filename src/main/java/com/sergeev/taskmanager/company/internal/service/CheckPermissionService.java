...
public class CheckPermissionService implements CheckPermissionApi {
    ...
    @Override
    public List<Long> findUserIdsWithPermission(Long companyId, PermissionEnum permission) {
        return membershipRepository.findUserIdsByPermissionAndCompany(permission, companyId);
    }
}
